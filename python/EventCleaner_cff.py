...
evtcleaner = cms.EDFilter("EventCleaner",
    ...
    File_EWK                   = cms.string('scalefactors_v4.root'),
    File_PUDistData            = cms.string('PUXsec_69400.root'),
    File_PUDistDataLow         = cms.string('PUXsec_65950.root'),
    File_PUDistDataHigh        = cms.string('PUXsec_72850.root'),
